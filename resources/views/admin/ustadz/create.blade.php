...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Tambah Ustadz</h1>
            <p class="text-sm text-gray-500 mt-0.5">Isi data ustadz baru di bawah ini</p>
        </div>
    </div>

    {{-- Form --}}
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('admin.ustadz.store') }}" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                >
                <p class="mt-1 text-xs text-gray-400">Nomor identitas akan digunakan sebagai username dan password awal.</p>
