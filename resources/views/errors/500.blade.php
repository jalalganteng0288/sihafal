...
<body class="min-h-screen bg-gray-50 flex items-center justify-center px-4">
    <div class="text-center max-w-md">
        ...
        <h2 class="text-xl font-semibold text-gray-700 mb-3">Kesalahan Server</h2>
        <p class="text-gray-500 mb-8">Terjadi kesalahan pada server. Silakan coba lagi nanti.</p>
        <a href="{{ url('/') }}"
